...
export const BASE_RADIUS = 13.5;
export const MAX_RADIUS = 50;
export const BASE_SPEED = 3.85;
export const BOOST_SPEED = 7.2;
export const TURN_SPEED = 0.065;
export const BOOST_TURN_SPEED = 0.088;
export const SEGMENT_SPACING = 8;
export const MIN_BOOST_MASS = 18;

...
def main():
    ...
    with open('scripts/benchmark/punisher_net.json', 'w') as f:
        json.dump(weights, f)

    print(f"\n✅ Exported trained punisher network to scripts/benchmark/punisher_net.json in {time.time() - t0:.1f}s!")
